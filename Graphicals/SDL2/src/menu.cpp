...
//                 if (event.button.y >= 450 && event.button.y <= 500 && event.button.x >= gamesX &&
//                     event.button.x <= gamesX + 200) {
//                     // Clic sur OpenGL
//                     lib = LibChoices[0];
//                     cout << "You clicked on OpenGL" << endl;
//                 } else if (event.button.y >= 500 && event.button.y <= 550 &&
//                            event.button.x >= gamesX && event.button.x <= gamesX + 200) {
//                     // Clic sur Ncurses
//                     lib = LibChoices[1];
...
//         drawText(renderer, font, "Choose a library:", gamesX - 100 + COLUMN_PADDING, y);
//         drawText(renderer, font, "Nibbler", gamesX + COLUMN_PADDING, y + 50);
//         drawText(renderer, font, "Snake", gamesX + COLUMN_PADDING, y + 100);
//         drawText(renderer, font, "Game selected: " + game, gamesX + COLUMN_PADDING, y + 200);
//         drawText(renderer, font, "Library selected: " + lib, gamesX + COLUMN_PADDING, y + 250);
//         drawText(renderer, font, "Click here to start the game", gamesX + COLUMN_PADDING, y + 450);
